...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE10_LITE_Qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DE10_LITE_Qsys
SOPC_NAME := DE10_LITE_Qsys
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1476955003
SOPC_SYSID_FLAG += --timestamp=1476955003
ELF_PATCH_FLAG  += --timestamp 1476955003
