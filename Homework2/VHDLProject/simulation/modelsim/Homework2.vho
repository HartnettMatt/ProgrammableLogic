...
-- Design Ports Information
-- a0[3]	=>  Location: PIN_K1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a0[2]	=>  Location: PIN_L15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a0[1]	=>  Location: PIN_E22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a0[0]	=>  Location: PIN_W9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- c0[0]	=>  Location: PIN_V5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- c0[1]	=>  Location: PIN_N5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- c0[2]	=>  Location: PIN_B19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- c0[3]	=>  Location: PIN_H12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- c0[4]	=>  Location: PIN_Y10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- c0[5]	=>  Location: PIN_E20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Y1	=>  Location: PIN_C11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Q2[0]	=>  Location: PIN_E12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Q2[1]	=>  Location: PIN_D13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Q2[2]	=>  Location: PIN_J12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Q2[3]	=>  Location: PIN_A13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- TC2	=>  Location: PIN_H13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A1	=>  Location: PIN_A10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- C1	=>  Location: PIN_A11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- B1	=>  Location: PIN_C10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- CET2	=>  Location: PIN_C12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SR2	=>  Location: PIN_D14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- P2[0]	=>  Location: PIN_B15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PE2	=>  Location: PIN_B14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- P2[1]	=>  Location: PIN_E13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- P2[2]	=>  Location: PIN_C13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- P2[3]	=>  Location: PIN_A14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \U1|Y~0_combout\ = (\A1~input_o\ & ((\C1~input_o\) # (\B1~input_o\))) # (!\A1~input_o\ & (\C1~input_o\ & \B1~input_o\))
...
-- Equation(s):
-- \U2|count[0]~1_combout\ = (((\CET2~input_o\ & \CEP2~input_o\)) # (!\SR2~input_o\)) # (!\PE2~input_o\)
...
-- Equation(s):
-- \U2|count~2_combout\ = (\PE2~input_o\ & (\SR2~input_o\ & (\U2|count\(0) $ (\U2|count\(1)))))
...
-- Equation(s):
-- \U2|count~3_combout\ = (\U2|count~2_combout\) # ((!\PE2~input_o\ & (\SR2~input_o\ & \P2[1]~input_o\)))
...
-- Equation(s):
-- \U2|Add0~1_combout\ = \U2|count\(3) $ (((\U2|count\(2) & (\U2|count\(1) & \U2|count\(0)))))
...
-- Equation(s):
-- \U2|TC~0_combout\ = (\CET2~input_o\ & (\U2|count\(0) & (\U2|count\(1) & \U2|count\(2))))
...
-- Equation(s):
-- \U2|TC~combout\ = (\U2|count\(3) & \U2|TC~0_combout\)
