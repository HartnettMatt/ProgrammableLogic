# Written by Synplify Pro version map202003act, Build 160R. Synopsys Run ID: sid1701139042 
...
set Inferred_clkgroup_0 [list SlowFast|Aclk]
set Inferred_clkgroup_1 [list SlowFast|Bclk]
