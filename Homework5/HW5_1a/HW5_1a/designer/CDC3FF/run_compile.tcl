...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"X:\Graduate\ECEN5863\ProgrammableLogic\Homework5\HW5_1a\HW5_1a\synthesis\CDC3FF.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {X:\Graduate\ECEN5863\ProgrammableLogic\Homework5\HW5_1a\HW5_1a\designer\CDC3FF} \
    -design CDC3FF \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
