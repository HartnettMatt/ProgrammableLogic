...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"X:\Graduate\ECEN5863\ProgrammableLogic\Homework5\HW5\synthesis\CDC3FF.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {X:\Graduate\ECEN5863\ProgrammableLogic\Homework5\HW5\designer\CDC3FF} \
    -design CDC3FF \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
