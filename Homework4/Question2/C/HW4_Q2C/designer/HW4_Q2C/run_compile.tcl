...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"X:\Graduate\ECEN5863\ProgrammableLogic\Homework4\Question2\C\HW4_Q2C\synthesis\HW4_Q2C.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {X:\Graduate\ECEN5863\ProgrammableLogic\Homework4\Question2\C\HW4_Q2C\designer\HW4_Q2C} \
    -design HW4_Q2C \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
