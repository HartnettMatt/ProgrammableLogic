...
//--              in the Work Library.
//--             The HW3Q1 component is instantiated. This is the component
//--             under test.  Other devices on the board are modeled as processes
//--             which run concurrently.
//--
//--              The architecture is a 2D register array that is 9 bits across
//--              and 8 blocks deep. Reading and writing behaves like a standard
//--              FIFO. There is also the ability to reset the read and write
//--              pointers, as well as increment them without the read/write operation
//
//--	 TESTS
//--   I. Write data into the FIFO
//--   II. Read data out of the FIFO
//--   III. Pointer resets and increments
//--
