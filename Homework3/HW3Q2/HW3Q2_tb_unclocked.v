...
//--              test bench for an FPGA implementation of 32 bit wide ALU that is not clocked.
//--  Hierarchy:  This test bench uses the HW3Q2 component found
//--              in the Work Library.
//--             The HW3Q2_unclocked component is instantiated. This is the component 
...
HW3Q2_unclocked dut    // Device under Test  #(.TIME(10))
	( 
		// Inputs
		.A(A),
		.B(B),
